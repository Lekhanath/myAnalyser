...
public class dst_mon {
	...
	public float e_DCSL1_tX, e_DCSL1_tY, e_DCSL2_tX, e_DCSL2_tY, e_DCSL3_tX, e_DCSL3_tY, e_DCSL4_tX, e_DCSL4_tY,
			e_DCSL5_tX, e_DCSL5_tY, e_DCSL6_tX, e_DCSL6_tY;
	public float e_PCAL_X, e_PCAL_Y, e_PCAL_Z, e_PCAL_edep, e_PCAL_t, e_EC_ein, e_EC_eout, e_EC_etot, e_PCAL_path,
			e_PCAL_vt;
	...
	public float pip_mom, pip_the, pip_phi, pip_vx, pip_vy, pip_vz, pip_beta, pip_FTOF1b_t, pip_FTOF1b_path,
			pip_FTOF1b_vt;
	...
	public float G1_pcal_X, G1_pcal_Y, G1_pcal_Z, G1_pcal_t, G1_pcal_R, G1_pcal_vt, G2_pcal_X, G2_pcal_Y, G2_pcal_Z,
			G2_pcal_t, G2_pcal_R, G2_pcal_vt;
	...
	public H2F[] H_FTOF_pos_beta_mom_pad1a, H_FTOF_neg_beta_mom_pad1a, H_FTOF_pos_beta_mom_pad1b,
			H_FTOF_neg_beta_mom_pad1b;
	public H2F[] H_FTOF_pos_mass_mom_pad1a, H_FTOF_pos_mass_the_pad1a, H_FTOF_neg_mass_mom_pad1a,
			H_FTOF_neg_mass_the_pad1a;
	public H2F[] H_FTOF_pos_mass_mom_pad1b, H_FTOF_pos_mass_the_pad1b, H_FTOF_neg_mass_mom_pad1b,
			H_FTOF_neg_mass_the_pad1b;
	...
	public H2F H_epip_Dphi_phi, H_epip_Dphi_theta, H_epip_Dphi_vz, H_epip_beta_p, H_epip_FTOF1b_dt_epad,
			H_epip_FTOF1b_dt_pippad;
	...
	public dst_mon(int reqrunNum, float reqEB) {
		...
		for (int ic = 0; ic < 10; ic++) {
			H_e_HTCC_cut[ic] = new H2F(String.format("H_e_HTCC_cut_%d", ic + 1),
					String.format("H_e_HTCC_cut_%d", ic + 1), 200, -100, 100, 200, -100, 100);
		...
		for (int s = 0; s < 6; s++)
			for (int it = 0; it < 15; it++)
				for (int ip = 0; ip < 30; ip++) {
					H_e_bin_nphe_HTCC[s][it][ip] = new H1F(String.format("H_e_bin_nphe_HTCC_%d_%d_%d", s, it, ip),
							String.format("H_e_bin_nphe_HTCC_%d_%d_%d", s, it, ip), 50, 0, 50);
					H_e_bin_nphe_HTCC[s][it][ip]
							.setTitle(String.format("HTCC nphe s%d #theta%d #phi%d", s + 1, it + 1, ip + 1));
		...
		for (int s = 0; s < 6; s++) {
			H_e_t_p[s] = new H2F(String.format("H_e_t_p_%d", s + 1), String.format("H_e_t_p_%d", s + 1), 100, 0, EB,
					100, 0, 40);
			H_e_t_p[s].setTitle("electron #theta vs p S" + (s + 1));
			H_e_t_p[s].setTitleX("p (GeV)");
			H_e_t_p[s].setTitleY("#theta (^o)");
			H_e_vz_t[s] = new H2F(String.format("H_e_vz_t_%d", s + 1), String.format("H_e_vz_t_%d", s + 1), 100, 0, 40,
					100, -15, 15);
			H_e_vz_t[s].setTitle("electron vz vs #theta S" + (s + 1));
			H_e_vz_t[s].setTitleX("#theta (^o)");
			H_e_vz_t[s].setTitleY("vz (cm)");
			H_e_vz_p[s] = new H2F(String.format("H_e_vz_p_%d", s + 1), String.format("H_e_vz_p_%d", s + 1), 100, 0, EB,
					100, -15, 15);
			H_e_vz_p[s].setTitle("electron vz vs p S" + (s + 1));
			H_e_vz_p[s].setTitleX("p (GeV)");
			H_e_vz_p[s].setTitleY("vz (cm)");

			H_e_EC_etot_p[s] = new H2F(String.format("H_e_EC_etot_p_%d", s + 1),
					String.format("H_e_EC_etot_p_%d", s + 1), 100, 0, EB, 100, 0.1, 0.4);
			...
			// H_e_EC_vt_theta[s] = new
			// H2F(String.format("H_e_EC_vt_theta_%d",s+1),String.format("H_e_EC_vt_theta_%d",s+1),100,0,40,100,80,120);
			H_e_EC_vt_theta[s] = new H2F(String.format("H_e_EC_vt_theta_%d", s + 1),
					String.format("H_e_EC_vt_theta_%d", s + 1), 100, 0, 40, 100, -4, 4);
			...
			H_e_EC_XY[s] = new H2F(String.format("H_e_EC_XY_%d", s + 1), String.format("H_e_EC_XY_%d", s + 1), 200, 0,
					400, 200, -200, 200);
			H_e_EC_XY[s].setTitle(String.format("PCAL Y vs X S%d", s + 1));
			H_e_EC_XY[s].setTitleX("X (cm)");
			H_e_EC_XY[s].setTitleY("Y (cm)");
			H_e_FTOF_vt_pad1a[s] = new H2F(String.format("H_e_FTOF_vt_pad1a_%d", s + 1),
					String.format("H_e_FTOF_vt_pad1a_%d", s + 1), 25, 0, 25, 100, -4, 4);
			...
			H_e_FTOF_edep_pad1a[s] = new H2F(String.format("H_e_FTOF_edep_pad1a_%d", s + 1),
					String.format("H_e_FTOF_edep_pad1a_%d", s + 1), 25, 0, 25, 100, 0, 25);
			...
			H_e_FTOF_XY_pad1a[s] = new H2F(String.format("H_e_FTOF_XY_pad1a_%d", s + 1),
					String.format("H_e_FTOF_XY_pad1a_%d", s + 1), 50, 0, 400, 100, -200, 200);
			...
			H_e_FTOF_vt_pad1b[s] = new H2F(String.format("H_e_FTOF_vt_pad1b_%d", s + 1),
					String.format("H_e_FTOF_vt_pad1b_%d", s + 1), 65, 0, 65, 100, -4, 4);
			...
			H_FTOF_pos_beta_mom_pad1a[s] = new H2F(String.format("H_FTOF_pos_beta_mom_pad1a_%d", s + 1),
					String.format("H_FTOF_pos_beta_mom_pad1a_%d", s + 1), 100, 0, EB, 100, 0, 1.2);
			...
			H_FTOF_neg_beta_mom_pad1a[s] = new H2F(String.format("H_FTOF_pos_beta_neg_pad1a_%d", s + 1),
					String.format("H_FTOF_pos_beta_neg_pad1a_%d", s + 1), 100, 0, EB, 100, 0, 1.2);
			...
			H_FTOF_pos_beta_mom_pad1b[s] = new H2F(String.format("H_FTOF_pos_beta_mom_pad1b_%d", s + 1),
					String.format("H_FTOF_pos_beta_mom_pad1b_%d", s + 1), 100, 0, EB, 100, 0, 1.2);
			...
			H_FTOF_neg_beta_mom_pad1b[s] = new H2F(String.format("H_FTOF_pos_beta_neg_pad1b_%d", s + 1),
					String.format("H_FTOF_pos_beta_neg_pad1b_%d", s + 1), 100, 0, EB, 100, 0, 1.2);
			...
			H_FTOF_pos_mass_mom_pad1a[s] = new H2F(String.format("H_FTOF_pos_mass_mom_pad1a_%d", s + 1),
					String.format("H_FTOF_pos_mass_mom_pad1a_%d", s + 1), 100, 0, 5, 150, -0.5, 4.5);
			...
			H_FTOF_pos_mass_the_pad1a[s] = new H2F(String.format("H_FTOF_pos_mass_the_pad1a_%d", s + 1),
					String.format("H_FTOF_pos_mass_the_pad1a_%d", s + 1), 100, 0, 45, 100, -0.5, 3.5);
			...
			H_FTOF_neg_mass_mom_pad1a[s] = new H2F(String.format("H_FTOF_neg_mass_mom_pad1a_%d", s + 1),
					String.format("H_FTOF_neg_mass_mom_pad1a_%d", s + 1), 100, 0, 5, 100, -0.5, 3.5);
			...
			H_FTOF_neg_mass_the_pad1a[s] = new H2F(String.format("H_FTOF_neg_mass_the_pad1a_%d", s + 1),
					String.format("H_FTOF_neg_mass_the_pad1a_%d", s + 1), 100, 0, 45, 100, -0.5, 3.5);
			...
			H_FTOF_pos_mass_mom_pad1b[s] = new H2F(String.format("H_FTOF_pos_mass_mom_pad1b_%d", s + 1),
					String.format("H_FTOF_pos_mass_mom_pad1b_%d", s + 1), 100, 0, 5, 100, -0.5, 4.5);
			...
			H_FTOF_pos_mass_the_pad1b[s] = new H2F(String.format("H_FTOF_pos_mass_the_pad1b_%d", s + 1),
					String.format("H_FTOF_pos_mass_the_pad1b_%d", s + 1), 100, 0, 45, 100, -0.5, 3.5);
			...
			H_FTOF_neg_mass_mom_pad1b[s] = new H2F(String.format("H_FTOF_neg_mass_mom_pad1b_%d", s + 1),
					String.format("H_FTOF_neg_mass_mom_pad1b_%d", s + 1), 100, 0, 5, 100, -0.5, 3.5);
			...
			H_FTOF_neg_mass_the_pad1b[s] = new H2F(String.format("H_FTOF_neg_mass_the_pad1b_%d", s + 1),
					String.format("H_FTOF_neg_mass_the_pad1b_%d", s + 1), 100, 0, 45, 100, -0.5, 3.5);
			...
			H_e_FTOF_edep_pad1b[s] = new H2F(String.format("H_e_FTOF_edep_pad1b_%d", s + 1),
					String.format("H_e_FTOF_edep_pad1b_%d", s + 1), 65, 0, 65, 100, 0, 25);
			...
			H_e_FTOF_XY_pad1b[s] = new H2F(String.format("H_e_FTOF_XY_pad1b_%d", s + 1),
					String.format("H_e_FTOF_XY_pad1b_%d", s + 1), 100, 0, 400, 100, -200, 200);
			...
			// H_e_LTCC_vt_theta[s] = new
			// H2F(String.format("H_e_LTCC_vt_theta_%d",s+1),String.format("H_e_LTCC_vt_theta_%d",s+1),100,0,40,100,-5,5);
			H_e_LTCC_vt_theta[s] = new H2F(String.format("H_e_LTCC_vt_theta_%d", s + 1),
					String.format("H_e_LTCC_vt_theta_%d", s + 1), 100, 0, 40, 100, -200, 150);
			...
			H_e_LTCC_nphe_theta[s] = new H2F(String.format("H_e_LTCC_nphe_theta_%d", s + 1),
					String.format("H_e_LTCC_nphe_theta_%d", s + 1), 100, 0, 40, 100, 0, 50);
			...
			H_e_LTCC_XY[s] = new H2F(String.format("H_e_LTCC_XY_%d", s + 1), String.format("H_e_LTCC_XY_%d", s + 1),
					100, 0, 400, 100, -100, 100);
			H_e_LTCC_XY[s].setTitle(String.format("LTCC Y vs X S%d", s + 1));
			H_e_LTCC_XY[s].setTitleX("X (cm)");
			H_e_LTCC_XY[s].setTitleY("Y (cm)");
			// H_e_HTCC_vt_theta[s] = new
			// H2F(String.format("H_e_HTCC_vt_theta_%d",s+1),String.format("H_e_HTCC_vt_theta_%d",s+1),100,0,40,100,-5,5);
			H_e_HTCC_vt_theta[s] = new H2F(String.format("H_e_HTCC_vt_theta_%d", s + 1),
					String.format("H_e_HTCC_vt_theta_%d", s + 1), 100, 0, 40, 100, -100, 100);
			...
			H_e_HTCC_nphe_theta[s] = new H2F(String.format("H_e_HTCC_nphe_theta_%d", s + 1),
					String.format("H_e_HTCC_nphe_theta_%d", s + 1), 100, 0, 40, 100, 0, 50);
			...
			H_e_HTCC_XY[s] = new H2F(String.format("H_e_HTCC_XY_%d", s + 1), String.format("H_e_HTCC_XY_%d", s + 1), 50,
					0, 100, 50, -50, 50);
		...
		// H_elast_e_th_p = new
		// H2F("H_elast_e_th_p","H_elast_e_th_p",100,0,EB,100,0,40);
		...
		for (int s = 0; s < 6; s++) {
			H_elast_W_Q2[s] = new H2F(String.format("H_elast_W_Q2_%d", s + 1), String.format("H_elast_W_Q2_%d", s + 1),
					400, 0, 4, 100, 0, 1.5);
			H_elast_W_Q2[s].setTitle(String.format("Q^2 vs W S%d", s + 1));
			H_elast_W_Q2[s].setTitleX("W ( GeV)");
			H_elast_W_Q2[s].setTitleY("Q^2 (GeV^2)");
			// H_elast_W_theta[s] = new
			// H2F(String.format("H_elast_W_theta_%d",s+1),String.format("H_elast_W_theta_%d",s+1),100,0,4,100,0,40);
			H_elast_W_theta[s] = new H2F(String.format("H_elast_W_theta_%d", s + 1),
					String.format("H_elast_W_theta_%d", s + 1), 400, 0, 4, 7, 5, 12);
			...
			// H_elast_inc_W_theta[s] = new
			// H2F(String.format("H_elast_inc_W_theta_%d",s+1),String.format("H_elast_inc_W_theta_%d",s+1),100,0,4,100,0,40);
			H_elast_inc_W_theta[s] = new H2F(String.format("H_elast_inc_W_theta_%d", s + 1),
					String.format("H_elast_inc_W_theta_%d", s + 1), 400, 0, 4, 12, 5, 17);
			...
			H_elast_dvz_theta[s] = new H2F(String.format("H_elast_dvz_theta_%d", s + 1),
					String.format("H_elast_dvz_theta_%d", s + 1), 100, 50, 80, 100, -5, 15);
		...
		for (int s = 0; s < 6; s++) {
			H_epip_W_theta[s] = new H2F(String.format("H_epip_W_theta_%d", s + 1),
					String.format("H_epip_W_theta_%d", s + 1), 100, 0, 4, 100, 0, 40);
			...
			H_epip_inc_W_theta[s] = new H2F(String.format("H_epip_inc_W_theta_%d", s + 1),
					String.format("H_epip_inc_W_theta_%d", s + 1), 100, 0, 4, 100, 0, 40);
	...
	public int getNelecs() {
		return this.Nelecs;
	}

	public int getNtrigs() {
		return this.Ntrigs;
	}
	...
	public double Vangle(Vector3 v1, Vector3 v2) {
		...
		if (l1 * l2 != 0 && Math.abs(prod) < l1 * l2)
			res = Math.toDegrees(Math.acos(prod / (l1 * l2)));
		return res;
	}

	public int getSect(DataBank bank, int partInd) {
		for (int k = 0; k < bank.rows(); k++) {
			if (bank.getShort("pindex", k) == partInd)
				return bank.getInt("sector", k);
		}
		return -1;
	}
	...
	public boolean fillConfBank(DataBank confbank) {
		...
		if (trigger_bits[1] || trigger_bits[2] || trigger_bits[3] || trigger_bits[4] || trigger_bits[5]
				|| trigger_bits[6]) {
			selectTrig = true;
			Ntrigs++;
			if (trigger_bits[1])
		...
		for (int r = 0; r < bank.rows(); r++) {
			if (bank.getShort("pindex", r) == e_part_ind) {
				if (bank.getByte("layer", r) == 1) {
					...
					if (e_sect == 0)
						e_sect = bank.getByte("sector", r);
				}
				if (bank.getByte("layer", r) == 4)
					e_EC_ein += bank.getFloat("energy", r);
				if (bank.getByte("layer", r) == 7)
					e_EC_eout += bank.getFloat("energy", r);
			}
			if (bank.getShort("pindex", r) == G1_part_ind) {
				if (bank.getByte("layer", r) == 1 && G1_pcal_ind == -1) {
					...
					// G1_pcal_R = G1_pcal_X*G1_pcal_X + G1_pcal_Y*G1_pcal_Y +
					// (G1_pcal_Z-e_vz)*(G1_pcal_Z-e_vz);
				...
				// }
				else if (bank.getByte("layer", r) > 1)
					G1_cal_layers++;
			}
			if (bank.getShort("pindex", r) == G2_part_ind) {
				if (bank.getByte("layer", r) == 1 && G2_pcal_ind == -1) {
					...
					// G2_pcal_R = G2_pcal_X*G2_pcal_X + G2_pcal_Y*G2_pcal_Y +
					// (G2_pcal_Z-e_vz)*(G2_pcal_Z-e_vz);
	...
	public void fillTraj(DataBank trajBank) {
		for (int r = 0; r < trajBank.rows(); r++) {
			// System.out.println("comparing "+e_part_ind+" and
			// "+trajBank.getInt("pindex",r));
			if (trajBank.getShort("pindex", r) == e_part_ind) {
				...
				case 0:
					...
					while (e_HTCC_phi > 60)
						e_HTCC_phi -= 60;
					float htccR = (float) Math
							.sqrt(e_HTCC_tX * e_HTCC_tX + e_HTCC_tY * e_HTCC_tY + e_HTCC_tZ * e_HTCC_tZ);
					// System.out.println("htccR="+htccR);
					e_HTCC_theta = (float) Math.toDegrees(Math.acos(e_HTCC_tZ / htccR));
					e_HTCC_bin_theta = -1;
					e_HTCC_bin_phi = -1;
					if (e_HTCC_theta > 5 && e_HTCC_theta < 10)
						e_HTCC_bin_theta = (int) ((e_HTCC_theta - 5f) / 1f);
					if (e_HTCC_theta > 10 && e_HTCC_theta < 20)
						e_HTCC_bin_theta = 5 + (int) ((e_HTCC_theta - 10f) / 2f);
					if (e_HTCC_theta > 20 && e_HTCC_theta < 40)
						e_HTCC_bin_theta = 10 + (int) ((e_HTCC_theta - 20f) / 4f);
					if (e_HTCC_phi < 20)
						e_HTCC_bin_phi = (int) (e_HTCC_phi / 4f);
					if (e_HTCC_phi > 20 && e_HTCC_phi < 40)
						e_HTCC_bin_phi = 5 + (int) ((e_HTCC_phi - 20f) / 1f);
					if (e_HTCC_phi > 40)
						e_HTCC_bin_phi = 25 + (int) ((e_HTCC_phi - 40f) / 4f);
				case 12:
	...
	public void makeOthers(DataBank bank) {
		for (int k = 0; k < bank.rows(); k++) {
			...
			// if(pid == 211 && pip_part_ind==-1 && inDC &&
			// Math.abs(bank.getFloat("chi2pid", k))<3 ){}
			...
			// if( (pid == 22 || (runNum<2600&&bank.getByte("charge",k)==0) ) &&
			// (mom>0.6||runNum<2600) && the>6 && G1_mom < mom ){}
			...
			// if( G1_part_ind>-1 && k!=G1_part_ind && (mom>0.6||runNum<2600) && the>6 &&
			// (pid == 22 || (runNum<2600&&bank.getByte("charge",k)==0))
			// && G2_mom < mom && mom < G1_mom){}
			if (G1_part_ind > -1 && k != G1_part_ind && mom > 0.4 && the > 6 && bank.getByte("charge", k) == 0
					&& G2_mom < mom && mom < G1_mom) {
				G2_part_ind = k;
				G2_mom = mom;
				G2_the = the;
	...
	public boolean selectElastic() {
		...
		if (prot_part_ind > -1) {
			...
			if (EB < 4f && prot_the > 60f - 30f * prot_mom)
				res = true;
			if (EB > 4f && EB < 9f && Math.abs(elast_dPhi) < 10f && prot_the > 55f && prot_the > 70f - 30f * prot_mom
					&& Math.abs(elast_EB - 6.5f) < 1.2f)
				res = true;
			if (EB > 9f && Math.abs(elast_dPhi) < 10f && prot_the > 70f - 30f * prot_mom
					&& Math.abs(elast_EB - 10f) < 1.2f)
				res = true;
		}
		return res;
	}
	...
	public boolean select_epi0() {
		...
		// && (runNum<2600 || (e_PCAL_t>190 && e_PCAL_t<210 && Math.abs(e_PCAL_t -
		// G1_pcal_t) < 5 && Math.abs(e_PCAL_t - G2_pcal_t) < 5 ))
		// && Math.abs(G1_pcal_vt)<3 && Math.abs(G2_pcal_vt)<3
			...
			if (runNum > 2600 && pi0_open > 3 && pi0_open > 9 * (1 - pi0_E / 4) && pi0_the > 8 && pi0_mass > 0.05
					&& pi0_mass < 0.5)
				res = true;
			if (runNum < 2600)
				res = true;
	...
	public void processEvent(DataEvent event) {
		...
		if (event.hasBank("RUN::config") && fillConfBank(event.getBank("RUN::config"))) {
			...
			if (event.hasBank("REC::Particle"))
				e_part_ind = makeElectron(event.getBank("REC::Particle"));
			if (e_part_ind > -1) {
				makeOthers(event.getBank("REC::Particle"));
				e_sect = 0;
				if (event.hasBank("REC::Track"))
					e_sect = getSect(event.getBank("REC::Track"), e_part_ind);
				if (event.hasBank("REC::Traj"))
					fillTraj(event.getBank("REC::Traj"));
				if (event.hasBank("REC::Cherenkov"))
					fillCerenkov(event.getBank("REC::Cherenkov"));
				if (event.hasBank("REC::Scintillator"))
					fillFTOF(event.getBank("REC::Particle"), event.getBank("REC::Scintillator"));
				if (event.hasBank("REC::Calorimeter"))
					fillECAL(event.getBank("REC::Calorimeter"));
				// if(e_sect>0 && found_eTraj){}
				if (e_sect > 0) {
					Nelecs++;
					Nelecs_sect[e_sect - 1]++;
					FillHists();
				}
			} // if e_part_ind>-1
	...
	public void FillHists() {
		...
		if (found_eECAL) {
			// e_PCAL_X, e_PCAL_Y, e_PCAL_Z, e_PCAL_edep, e_PCAL_t, e_EC_ein, e_EC_eout,
			// e_EC_etot, e_PCAL_path, e_PCAL_vt;
			Vector3 pos = new Vector3(e_PCAL_X, e_PCAL_Y, e_PCAL_Z);
			pos.rotateZ(-s * Math.toRadians(60));
			H_e_EC_etot_p[s].fill(e_mom, e_EC_etot / e_mom);
			H_e_EC_vt_theta[s].fill(e_the, e_PCAL_vt);
			H_e_EC_XY[s].fill(pos.x(), pos.y());
		}
		if (found_eFTOF1a) {
			// e_FTOF1a_X, e_FTOF1a_Y, e_FTOF1a_Z, e_FTOF1a_edep, e_FTOF1a_t, e_FTOF1a_path,
			// e_FTOF1a_vt;
			Vector3 pos = new Vector3(e_FTOF1a_X, e_FTOF1a_Y, e_FTOF1a_Z);
			pos.rotateZ(-s * Math.toRadians(60));
		...
		if (found_eFTOF1b) {
			// e_FTOF1b_X, e_FTOF1b_Y, e_FTOF1b_Z, e_FTOF1b_edep, e_FTOF1b_t, e_FTOF1b_path,
			// e_FTOF1b_vt;
			Vector3 pos = new Vector3(e_FTOF1b_X, e_FTOF1b_Y, e_FTOF1b_Z);
			pos.rotateZ(-s * Math.toRadians(60));
		...
		if (found_eLTCC) {
			...
			Vector3 pos = new Vector3(e_LTCC_X, e_LTCC_Y, e_LTCC_Z);
			pos.rotateZ(-s * Math.toRadians(60));
		...
		if (found_eHTCC) {
			...
			Vector3 pos = new Vector3(e_HTCC_X, e_HTCC_Y, e_HTCC_Z);
			pos.rotateZ(-s * Math.toRadians(60));
		...
		if (found_eTraj && found_eHTCC) {
			...
			if (true && e_HTCC_bin_theta > -1 && e_HTCC_bin_theta < 15 && e_HTCC_bin_phi > -1 && e_HTCC_bin_phi < 30)
				H_e_bin_nphe_HTCC[s][e_HTCC_bin_theta][e_HTCC_bin_phi].fill(e_HTCC_nphe);
			for (int ic = 0; ic < 10; ic++) {
				if (e_HTCC_nphe > ic + 1)
					H_e_HTCC_cut[ic].fill(e_HTCC_tX, e_HTCC_tY);
			}
		}
	...
	public void plot() {
		...
		can_e_overview.cd(0);
		can_e_overview.draw(H_e_t_f);
		can_e_overview.cd(1);
		can_e_overview.draw(H_e_p_f);
		can_e_overview.cd(2);
		can_e_overview.draw(H_e_vz_f);
		can_e_overview.cd(3);
		can_e_overview.draw(H_e_vt_vz);
		can_e_overview.cd(4);
		can_e_overview.draw(H_e_vt_p);
		can_e_overview.cd(5);
		can_e_overview.draw(H_e_vt_t);
		can_e_overview.cd(6);
		can_e_overview.draw(H_e_DCSL6);
		can_e_overview.cd(7);
		can_e_overview.draw(H_e_DCSL5);
		can_e_overview.cd(8);
		can_e_overview.draw(H_e_DCSL4);
		can_e_overview.cd(9);
		can_e_overview.draw(H_e_DCSL3);
		can_e_overview.cd(10);
		can_e_overview.draw(H_e_DCSL2);
		can_e_overview.cd(11);
		can_e_overview.draw(H_e_DCSL1);
		can_e_overview.cd(12);
		can_e_overview.draw(H_e_PCAL);
		can_e_overview.cd(13);
		can_e_overview.draw(H_e_FTOF);
		can_e_overview.cd(14);
		can_e_overview.draw(H_e_LTCC);
		can_e_overview.cd(15);
		can_e_overview.draw(H_e_HTCC);
		H_e_nphe_HTCC.divide(H_e_HTCC);
		can_e_overview.cd(16);
		can_e_overview.draw(H_e_nphe_HTCC);
		...
		can_e_htcc.cd(0);
		can_e_htcc.draw(H_e_HTCC);
		can_e_htcc.cd(1);
		can_e_htcc.draw(H_e_theta_HTCC);
		can_e_htcc.cd(2);
		can_e_htcc.draw(H_e_phi_HTCC);
		can_e_htcc.cd(3);
		can_e_htcc.draw(H_e_nphe_HTCC);
		can_e_htcc.getPad(3).getAxisZ().setRange(5, 25);
		can_e_htcc.cd(4);
		can_e_htcc.draw(H_e_bin_theta_HTCC);
		can_e_htcc.cd(5);
		can_e_htcc.draw(H_e_bin_phi_HTCC);
		if (runNum > 0) {
		...
		for (int ic = 0; ic < 10; ic++)
			H_e_HTCC_cut[ic].divide(H_e_HTCC);
		...
		for (int ic = 0; ic < 10; ic++) {
			can_e_htcc_cut.cd(ic);
			can_e_htcc_cut.draw(H_e_HTCC_cut[ic]);
		...
		for (int s = 0; s < 6; s++) {
			...
			for (int it = 0; it < 15; it++)
				for (int ip = 0; ip < 30; ip++)
					if (H_e_bin_nphe_HTCC[s][it][ip].getIntegral() > 50) {
						int pad = ip + 30 * it;
						can_e_htcc_spectr.cd(pad);
						can_e_htcc_spectr.draw(H_e_bin_nphe_HTCC[s][it][ip]);
					}
			if (runNum > 0) {
		...
		for (int s = 0; s < 6; s++) {
			can_e_sectors.cd(s);
			can_e_sectors.draw(H_e_t_p[s]);
			can_e_sectors.cd(s + 6);
			can_e_sectors.draw(H_e_vz_t[s]);
			can_e_sectors.cd(s + 12);
			can_e_sectors.draw(H_e_vz_p[s]);
		}
		if (runNum > 0) {
		...
		for (int s = 0; s < 6; s++) {
			can_e_ECAL.cd(s);
			can_e_ECAL.draw(H_e_EC_etot_p[s]);
			can_e_ECAL.cd(s + 6);
			can_e_ECAL.draw(H_e_EC_vt_theta[s]);
			can_e_ECAL.cd(s + 12);
			can_e_ECAL.draw(H_e_EC_XY[s]);
		}
		if (runNum > 0) {
		...
		for (int s = 0; s < 6; s++) {
			can_e_FTOF.cd(s);
			can_e_FTOF.draw(H_e_FTOF_vt_pad1a[s]);
			can_e_FTOF.cd(s + 6);
			can_e_FTOF.draw(H_e_FTOF_vt_pad1b[s]);
			can_e_FTOF.cd(s + 12);
			can_e_FTOF.draw(H_e_FTOF_edep_pad1a[s]);
			can_e_FTOF.cd(s + 18);
			can_e_FTOF.draw(H_e_FTOF_edep_pad1b[s]);
			can_e_FTOF.cd(s + 24);
			can_e_FTOF.draw(H_e_FTOF_XY_pad1a[s]);
			can_e_FTOF.cd(s + 30);
			can_e_FTOF.draw(H_e_FTOF_XY_pad1b[s]);
		}
		if (runNum > 0) {
		...
		for (int s = 0; s < 6; s++) {
			can_e_Cerenkov.cd(s);
			can_e_Cerenkov.draw(H_e_LTCC_vt_theta[s]);
			can_e_Cerenkov.cd(s + 6);
			can_e_Cerenkov.draw(H_e_LTCC_nphe_theta[s]);
			can_e_Cerenkov.cd(s + 12);
			can_e_Cerenkov.draw(H_e_LTCC_XY[s]);
			can_e_Cerenkov.cd(s + 18);
			can_e_Cerenkov.draw(H_e_HTCC_vt_theta[s]);
			can_e_Cerenkov.cd(s + 24);
			can_e_Cerenkov.draw(H_e_HTCC_nphe_theta[s]);
			can_e_Cerenkov.cd(s + 30);
			can_e_Cerenkov.draw(H_e_HTCC_XY[s]);
		}
		if (runNum > 0) {
		...
		can_elastic.cd(0);
		can_elastic.draw(H_elast_e_th_p);
		can_elastic.cd(1);
		can_elastic.draw(H_elast_p_th_p);
		can_elastic.cd(2);
		can_elastic.draw(H_elast_vz_vz);
		can_elastic.cd(3);
		can_elastic.draw(H_elast_dvz_phi);
		can_elastic.cd(4);
		can_elastic.draw(H_elast_dvz_theta_all);
		can_elastic.cd(5);
		can_elastic.draw(H_elast_dvz_vz);
		can_elastic.cd(6);
		can_elastic.draw(H_elast_Dphi_phi);
		can_elastic.cd(7);
		can_elastic.draw(H_elast_Dphi_theta);
		can_elastic.cd(8);
		can_elastic.draw(H_elast_Dphi_vz);
		can_elastic.cd(9);
		can_elastic.draw(H_elast_EB_phi);
		can_elastic.cd(10);
		can_elastic.draw(H_elast_EB_theta);
		can_elastic.cd(11);
		can_elastic.draw(H_elast_EB_vz);
		for (int s = 0; s < 6; s++) {
			can_elastic.cd(12 + s);
			can_elastic.draw(H_elast_W_Q2[s]);
			can_elastic.getPad(12 + s).getAxisX().setRange(0.5, 2.5);
			can_elastic.cd(18 + s);
			can_elastic.draw(H_elast_W_theta[s]);
			can_elastic.getPad(18 + s).getAxisX().setRange(0.5, 2.5);
			can_elastic.cd(24 + s);
			can_elastic.draw(H_elast_inc_W_theta[s].projectionX());
			can_elastic.cd(24 + s);
			can_elastic.draw(H_elast_W_theta[s].projectionX(), "same");
			can_elastic.getPad(24 + s).getAxisX().setRange(0.5, 2.5);
			// can_elastic.getPad(18+s).getAxisY().setLog(true);
			can_elastic.cd(30 + s);
			can_elastic.draw(H_elast_W_theta[s].projectionX());
			can_elastic.getPad(30 + s).getAxisX().setRange(0.5, 2.5);
			can_elastic.cd(36 + s);
			can_elastic.draw(H_elast_inc_W_theta[s]);
		...
		can_epip.cd(0);
		can_epip.draw(H_epip_e_th_p);
		can_epip.cd(1);
		can_epip.draw(H_epip_p_th_p);
		can_epip.cd(2);
		can_epip.draw(H_epip_vz_vz);
		can_epip.cd(3);
		can_epip.draw(H_epip_dvz_phi);
		can_epip.cd(4);
		can_epip.draw(H_epip_dvz_theta);
		can_epip.cd(5);
		can_epip.draw(H_epip_dvz_vz);
		can_epip.cd(6);
		can_epip.draw(H_epip_Dphi_phi);
		can_epip.cd(7);
		can_epip.draw(H_epip_Dphi_theta);
		can_epip.cd(8);
		can_epip.draw(H_epip_Dphi_vz);
		can_epip.cd(9);
		can_epip.draw(H_epip_beta_p);
		can_epip.cd(10);
		can_epip.draw(H_epip_FTOF1b_dt_epad);
		can_epip.cd(11);
		can_epip.draw(H_epip_FTOF1b_dt_pippad);
		for (int s = 0; s < 6; s++) {
			can_epip.cd(12 + s);
			can_epip.draw(H_epip_W_theta[s]);
			can_epip.cd(18 + s);
			can_epip.draw(H_epip_W_theta[s].projectionX());
		...
		can_epi0.cd(0);
		can_epi0.draw(H_pi0_G1_mom_the);
		can_epi0.cd(1);
		can_epi0.draw(H_pi0_G1_phi_the);
		can_epi0.cd(2);
		can_epi0.draw(H_pi0_G1_XY);
		can_epi0.cd(3);
		can_epi0.draw(H_pi0_G1_TR);
		can_epi0.cd(4);
		can_epi0.draw(H_pi0_G1_vt_evt);
		can_epi0.cd(5);
		can_epi0.draw(H_pi0_G1_layer_E);
		can_epi0.cd(6);
		can_epi0.draw(H_pi0_G2_mom_the);
		can_epi0.cd(7);
		can_epi0.draw(H_pi0_G2_phi_the);
		can_epi0.cd(8);
		can_epi0.draw(H_pi0_G2_XY);
		can_epi0.cd(9);
		can_epi0.draw(H_pi0_G2_TR);
		can_epi0.cd(10);
		can_epi0.draw(H_pi0_G2_vt_evt);
		can_epi0.cd(11);
		can_epi0.draw(H_pi0_G2_layer_E);
		can_epi0.cd(12);
		can_epi0.draw(H_pi0_G1_layers);
		can_epi0.cd(13);
		can_epi0.draw(H_pi0_G2_layers);
		can_epi0.cd(14);
		can_epi0.draw(H_pi0_open_E);
		can_epi0.cd(15);
		can_epi0.draw(H_pi0_E_the);
		can_epi0.cd(16);
		can_epi0.draw(H_pi0_phi_the);
		can_epi0.cd(17);
		can_epi0.draw(H_pi0_mass);
		if (runNum > 0) {
	...
	public void write() {
		...
		for (int ic = 0; ic < 10; ic++)
			dirout.addDataSet(H_e_HTCC_cut[ic]);
		for (int s = 0; s < 6; s++)
			for (int it = 0; it < 15; it++)
				for (int ip = 0; ip < 30; ip++)
					dirout.addDataSet(H_e_bin_nphe_HTCC[s][it][ip]);
		...
		if (runNum > 0)
			dirout.writeFile("plots" + runNum + "/dst_mon_" + runNum + ".hipo");
		else
			dirout.writeFile("plots/dst_mon.hipo");
	}
			...
			if (count < maxevents) {
				...
				while (reader.hasEvent() && count < maxevents) {
					...
					if (count % 10000 == 0) {
						...
						Date date = new Date();
						String TimeString = "          time : " + dateFormat.format(date) + " , last elapsed : "
								+ elapsedTime + "s ; total elapsed : " + totalTime + "s";
						int ntrigs = ana.getNtrigs();
						int nelecs = ana.getNelecs();
						float ratio = 0f;
						if (ntrigs > 0)
							ratio = 100f * nelecs / ntrigs;
						String diagnost = String.format("N elecs=%dk N trigs=%dk , r=%1.2f%% ; file %d/%d",
								nelecs / 1000, ntrigs / 1000, ratio, progresscount, filetot);
						// System.out.println(count/1000 + "k events, file "+(fileN+1)+" (dst_mon
						// running on "+runstrg+") "+diagnost);
						...
						for (int s = 0; s < 6; s++) {
							...
							if (T > 0)
								R = (100.0f * E) / (1.0f * T);
							// purity += "S"+(s+1)+" "+((T/1000))+"k , "+(E/1000)+"k
							// r="+String.format("%1.1f",R)+" ; ";
